...
setup(
    ...
    long_description_content_type='AFNI',  # Optional (see note above)
    ...
    # project.
    author='The AFNI team',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='afni.bootcamp@gmail.com',  # Optional
    ...
    keywords='fmri mri neuroimaging',  # Optional
